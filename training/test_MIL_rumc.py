...
def main(experiment_name, dataset, version_patch_selection):
      ...
      if dataset == "test":
            ...
            with torch.no_grad():
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[0]})")
                  plt.savefig(outputdir / f"valid_{epoch + 1}_cm_{names[0]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[1]})")
                  plt.savefig(outputdir / f"valid_{epoch + 1}_cm_{names[1]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[2]})")
                  plt.savefig(outputdir / f"valid_{epoch + 1}_cm_{names[2]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[3]})")
                  plt.savefig(outputdir / f"valid_{epoch + 1}_cm_{names[3]}.png")
                  plt.close()
            ...
            with torch.no_grad():
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[0]})")
                  plt.savefig(outputdir / f"train_{epoch + 1}_cm_{names[0]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[1]})")
                  plt.savefig(outputdir / f"train_{epoch + 1}_cm_{names[1]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[2]})")
                  plt.savefig(outputdir / f"train_{epoch + 1}_cm_{names[2]}.png")
                  plt.close()
                  ...
                  disp.plot()
                  plt.title(f"Confusion Matrix ({names[3]})")
                  plt.savefig(outputdir / f"train_{epoch + 1}_cm_{names[3]}.png")
                  plt.close()
