...
def main(experiment_name, version_patch_selection):
      ...
      for directory in subdirs:
            ...
            train_predictions_df = pd.read_csv(modeldir / directory / f"training_predictions_{epoch+1}.csv", index_col="filenames")
            ...
            valid_predictions_df = pd.read_csv(modeldir / directory / f"validation_predictions_{epoch+1}.csv", index_col="filenames")
