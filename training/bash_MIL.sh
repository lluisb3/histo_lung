...
=======
python3 -m training.train_MIL --config_file config_MIL --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL2 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL3 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL4 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL5 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL6 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL7 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL8 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL9 --exp_name_moco MoCo_resnet34_v2
python3 -m training.train_MIL --config_file config_MIL10 --exp_name_moco MoCo_resnet34_v2
# python3 -m training.train_MIL --config_file config_MIL11 --exp_name_moco MoCo_resnet101_v2
# python3 -m training.train_MIL --config_file config_MIL12 --exp_name_moco MoCo_resnet101_v2
>>>>>>> parent of 986ae2b... Ready for main
